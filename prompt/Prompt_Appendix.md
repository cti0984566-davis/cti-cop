  ...
  "actors": [
    {
      ...
      "日本にとっての重要性": "High",
      "最新の主要活動": "2026年4月、CISA等が中国系アクターによる侵害済みSOHO/IoT機器を用いた秘匿ネットワーク運用への対処勧告を公開。日本の重要インフラ、通信、委託先ネットワークへの迂回侵入リスクとして継続監視。",
    ...
    },
    {
      ...
      "日本にとっての重要性": "Medium",
      "最新の主要活動": "2026年5月、Gambit Securityが2026年3月のLos Angeles County Metropolitan Transportation Authority侵害をAbabil of Minabに関連付け。少なくとも700GBのデータ窃取、バックアップ・メール等の漏洩、交通機関・公共インフラ標的化が報告された。",
    ...
    },
    {
      ...
      "日本にとっての重要性": "High",
      "最新の主要活動": "2026年5月、FBIが米法律事務所を標的とするSRGの活動を警告。IT担当者を装う電話・メールに加え、失敗時には人物を現地に送ってUSB等を接続し、データ窃取を試みる対面型ソーシャルエンジニアリングを確認。",
      "ステータス": "新規（最終観測: 2026年5月）",
      "情報源": [
    ...
    },
    {
      ...
      "日本にとっての重要性": "High",
      "最新の主要活動": "2026年5月26日、CrowdStrike、Google、ShadowserverがGlassWormボットネットの4系統C2を同時遮断。2025年以降、盗難開発者認証情報、悪性拡張機能、汚染パッケージを通じて300超のGitHubリポジトリを汚染したと報告。",
      "ステータス": "新規（最終観測: 2026年5月）",
      "情報源": [
